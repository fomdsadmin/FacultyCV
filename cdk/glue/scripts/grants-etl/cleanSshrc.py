...
"""
This function will fetch the raw SSHRC data from the raw S3 bucket, clean it, and put the clean data
...
:param key_program_codes: the key (path) to the SSHRC program codes file
"""
