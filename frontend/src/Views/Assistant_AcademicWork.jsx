...
const Assistant_AcademicWork = ({ getCognitoUser, userInfo, toggleViewMode }) => {
  ...
  const handleTabSelect = (selectedCategory) => {
    ...
    if (!selectedCategory) {
      navigate("/assistant/academic-work");
    } else {
      ...
      navigate(`/assistant/academic-work/${categorySlugClean}`);
    }
  };
  ...
  const handleManageClick = (value) => {
    ...
    if (section) {
      ...
      navigate(`/assistant/academic-work/${categorySlugClean}/${titleSlugClean}`);
  ...
  const handleBack = () => {
    setActiveSection(null);
    if (category) {
      navigate(`/assistant/academic-work/${category}`);
    } else {
      navigate("/assistant/academic-work");
    }
  };
...
export default Assistant_AcademicWork;
