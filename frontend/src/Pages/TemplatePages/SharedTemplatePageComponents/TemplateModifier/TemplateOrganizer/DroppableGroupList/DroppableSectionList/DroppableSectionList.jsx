...
const DroppableSectionList = ({ group, isInHiddenGroup }) => {
        ...
        {(provided, snapshot) => (
            ...
            >
                {group.prepared_sections.map((preparedSection, preparedSectionIndex) => (
                    <DraggableSection
                        key={preparedSection.data_section_id}
                        draggableId={preparedSection.data_section_id}
                        preparedSectionIndex={preparedSectionIndex}
                        preparedSection={preparedSection}
                        isInHiddenGroup={isInHiddenGroup}
                    >
                    </DraggableSection>
                ))}
