    ...
    if (isPublicationsSection || isOtherPublicationsSection) {
      ...
      updatedList.forEach((author) => {
        if (author.name) {
          ...
          } else if (authorType === "Co-First Author") {
            authorTypes.co_first_authors.push(author.name);
          } else if (authorType === "Co-Senior Author") {
            authorTypes.co_senior_authors.push(author.name);
