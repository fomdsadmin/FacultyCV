...
export const useGenericSection = () => {
    ...
    if (!context) {
        throw new Error("useGenericSection must be used within a GenericSectionProvider")
    }
    return context
}
...
export const GenericSectionProvider = ({ children, user, section, onBack }) => {
    ...
    return <GenericSectionContext.Provider value={value}>{children}</GenericSectionContext.Provider>
}
