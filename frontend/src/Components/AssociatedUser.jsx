...
const AssociatedUser = ({ connection, getAllUserConnections }) => {
    ...
    const handleRemoveConfirm = async () => {
        ...
        try {
            ...
            await logAction(AUDIT_ACTIONS.DELETE_CONNECTION, { user_connection_id: connection.user_connection_id, user_connection_name: connection.assistant_first_name, user_connection_last_name: connection.assistant_last_name, email: connection.faculty_email });
        } catch (error) {
    ...
    const handleAccept = async () => {
        ...
        try {
            ...
            await logAction(AUDIT_ACTIONS.ACCEPT_CONNECTION, { user_connection_id: connection.user_connection_id, user_connection_name: connection.assistant_first_name, user_connection_last_name: connection.assistant_last_name, email: connection.faculty_email });
        } catch (error) {
            console.error('Error:', error);
        }
